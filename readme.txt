...
== Changelog ==
= 1.8.10 =
* Prefill the WooCommerce cart before redirecting to checkout.
* Clear persistent cart data to avoid stale products.

= 1.8.9 =
* Clear the WooCommerce cart before redirecting to add-to-cart.

= 1.8.8 =
* Force the JCC gateway during checkout for Taxnexcy submissions.

= 1.8.7 =
* Skip add-to-cart redirect when the product is already in the cart.
